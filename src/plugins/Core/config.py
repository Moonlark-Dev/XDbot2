...
class Config(BaseSettings):
    ...
    FILES = [{
        ...
        "text": json.dumps({"count": 0})
    }, {
        "path":
        "data/chatgpt.config.json",
        "text":
        json.dumps({
        ...
        "path":
        "data/random_events.disable.json",
        "text":
        json.dumps({
            "send_images": [],
            "download_images": [],
        ...
        "path": "data/cave.data.restore.json",
        "text": "{}"
    }
             # ,
             # {
